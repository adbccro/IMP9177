  ...
  public render(): void {
    ...
    if (dashboard === 'MRS') {
      ...
      html = makeHtml('RAID', 'RAID Register',
        ...
        RAID_BODY,
        'IMP9177 RAID Register &middot; ADB Consulting &amp; CRO Inc. &middot; Read-only view &middot; Live data from SharePoint lists'); } else if (dashboard === 'DOCREPO') {
          ...
          groupFields: [
            PropertyPaneChoiceGroup('dashboard', {
              ...
              options: [
                ...
                { key: 'DOCREPO', text: 'Document Repository' },
              ]
            })
          ]
        }]
